...
export const meta = {
  ...
  title: 'Creating fluffy trees with ThreeJS (part 2)',
};
...
- `normal`, supplied by ThreeJS, used to know the direction a vertex is facing. Vertices facing up should be more affected by wind.
- `position`, supplied by ThreeJS, used to offset the rotation value for varied rotations; and
