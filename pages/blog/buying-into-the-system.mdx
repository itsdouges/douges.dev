...
Is this perfect in all scenarios?
Definitely not.
It's a tradeoff,
optimizing for cohesion over perfection desiring faster development without needing to think about multiple moving parts and workarounds.
...
Given enough use cases the need to define all interaction states individually get pretty wild,
