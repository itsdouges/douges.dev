...
export const meta = {
  title: 'Defining systems to make UI development easier',
  blurb:
    'We all want to be aligned so we can execute with precision and speed, what systems could we define to make UI development?',
  publishDate: '2022-01-09',
  tags: ['UI', 'DESIGN SYSTEMS', 'WEB DEV', 'CSS', 'SCALE'],
  heroImage,
};

Believe it or not I [play ice](https://twitter.com/_douges/status/1455417512707837953?s=20) [hockey](https://twitter.com/_douges/status/1444889172410449925?s=20) [for fun](https://twitter.com/_douges/status/1371743285903912960) in Sydney,
Australia.
...
What systems could we define for <abbr title="User interface">UI</abbr> development?
...
[Let me know on Twitter](https://twitter.com/_douges) what you thought of this blog and if there are any areas you'd be interested to go deeper in.
More soon.
