...
What systems could we define to make <abbr title="User interface">UI</abbr> development more sensible?
...
Others that are in my mind include accessibility attributes that should be available to all areas of your system,
