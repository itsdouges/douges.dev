...
What systems could we define to make UI development more sensible?

# Boxes and borders

Today most web developers use the box sizing property to enable the [alternative box model](https://developer.mozilla.org/en-US/docs/Learn/CSS/Building_blocks/The_box_model#the_alternative_css_box_model) simplifying how we think about the size of an element rendered in the viewport.
...
The logical next step is to move layout concerns to parent elements instead.
Thanks to flex box and grid both supporting the gap property in all major browsers it's very easy to accomplish...
